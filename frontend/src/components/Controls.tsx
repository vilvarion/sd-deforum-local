...
export default function Controls({ config, onChange, onGenerate, disabled, models }: Props) {
  ...
  return (
    <div className={styles.panel}>
      ...
      <button className={styles.generateBtn} onClick={handleGenerate} disabled={disabled || !config.prompt.trim()}>
